...
-   **Transparent Proxy**: Contains the `_do_proxy` helper which forwards any request under `/api/z1sandbox/*` directly to the backend while injecting authentication and stripping unnecessary headers.
